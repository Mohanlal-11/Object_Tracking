...
from LightDetector.util import bbox2distance, distance2bbox, multi_apply, overlay_bbox_cv
...
class NanoDetPlusHead(nn.Module):
    ...
    def forward(self, feats):
        ...
        for feat, cls_convs, gfl_cls in zip(
            ...
            for conv in cls_convs:   # all feats share same head.
                feat = conv(feat)
            output = gfl_cls(feat)
    ...
    def get_bboxes(self, cls_preds, reg_preds, img_metas):
        ...
        # import pickle
        # with open("nanodet_bboxes_before_nsm.pickle", mode='wb') as f:
        #     pickle.dump(bboxes, f )
        
        scores = cls_preds.sigmoid()
        
        # with open("nanodet_scores_after_sigmoid.pickle", mode='wb') as f:
