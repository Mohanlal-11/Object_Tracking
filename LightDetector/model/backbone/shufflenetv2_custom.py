...
class ShuffleNetV2_Custom(nn.Module):
    def __init__(
        self,
        out_stages=(2, 3, 4),
        ...
        activation="ReLU",
        no_maxpool=False, 
        stage_out_channels = [12, 24, 48, 96, 512]
    ):
        super(ShuffleNetV2_Custom, self).__init__()
        ...
        self._stage_out_channels =  stage_out_channels # Our Custom
        ...
        if no_maxpool:
            self.maxpool = nn.Conv2d(in_channels=output_channels, out_channels=output_channels, kernel_size=2, stride=2)
